...
public class SimpleRanger implements Ranger {
    ...
    private final double DISTANCE_MAX = 5;
    ...
    private final double ANGLE_MAX = 67;
    ...
    private final double SPEED_MAX = 2500;
    ...
    public double[][] KNOWN_DATA = new double[][] {
        ...
        {DISTANCE_MAX, ANGLE_MAX, SPEED_MAX},
    };
    ...
    public FiringSolution getFiringSolution(double range) {
        ...
        if (range >= DISTANCE_MAX) {
            return new FiringSolution((int) Math.round(SPEED_MAX), ANGLE_MAX); 
        }
