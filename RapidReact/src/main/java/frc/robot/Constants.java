...
public final class Constants {
  ...
  // CAN IDs
  public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 4; // 1
  public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 3; // 2
  public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 2; // 3
  public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 1; // 4

  public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 8; // 5
  public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 7; // 6
  public static final int BACK_LEFT_MODULE_STEER_MOTOR = 6; // 7
  public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 5; // 8

  public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 12;// 9;
  public static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 11;// 10;
  public static final int BACK_LEFT_MODULE_STEER_ENCODER = 10;// 11;
  public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 9;// 12
  ...
  public static final int BOOM_RETRACT_SOLENOID_CHAN = 3;
  public static final int BOOM_EXTEND_SOLENOID_CHAN = 4;
